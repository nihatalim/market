...
{
    public class Privilege : BaseDTO
    {
        ...
        public static List<Privilege> GetInitialPrivileges()
        {
            List<Privilege> initialPrivileges = new List<Privilege> {
                ...
                new Privilege("Kullanıcı Düzenleme", "UpdateUserPrivilege", 35), // kendinin
                ...
                new Privilege("Tüm Müşterileri Görüntüleme", "GetAllClientsPrivilege", 41),
                new Privilege("Müşteri Arama", "SearchClientPrivilege", 42),
                new Privilege("Müşteri Bilgileri ve Siparişleri Görüntüleme", "GetClientWithOrdersPrivilege", 43),
            };
